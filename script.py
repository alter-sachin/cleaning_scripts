...
#video_capture = cv2.VideoCapture('rtsp://192.168.7.96:8800/')
# Load a sample picture and learn how to recognize it.
#obama_image = face_recognition.load_image_file("known_people/sachin.png")
#obama_face_encoding = face_recognition.face_encodings(obama_image)[0]

# Load a second sample picture and learn how to recognize it.
##biden_image = face_recognition.load_image_file("known_people/gonik.png")
...
while True:
    ...
    if process_this_frame:
        ...
        #if (len(face_location_check) > 0):
        #    print(len(face_location_check))
        #    face_locations = face_location_check
        ...
        for face_encoding in face_encodings:
            ...
            matches = face_recognition.compare_faces(total_face_encodings, face_encoding,tolerance = 0.45)
            print(matches)
            name = "Unknown"
